...
local RESET_CONFIRM = "Verknuepfung mit \"%s\" wirklich aufheben?\n"
    ...
    .. "Materialien, Gildenbank-Zwischenspeicher und vom Bot gelieferte Taktiknotizen.\n"
    .. "Deine eigenen Daten (Twinks, Fortschritt, Notizen) bleiben erhalten.\n"
...
local GUILD_KEYS = {
    ...
    "materialData", "guildBankCache", "bossData",
}
